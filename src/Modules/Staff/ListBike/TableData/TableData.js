            ...
            <div className="contentFirstTag">
                ...
                <div className="dropdown">
                    ...
                    <div className="dropdown-list">
                        <div className="dropdown-list-item" onClick={() => setUrl('https://nmcnpm.herokuapp.com/api/v2/station/bikes')}>Trạng thái: rảnh</div>
                        <div className="dropdown-list-item" onClick={() => setUrl('https://nmcnpm.herokuapp.com/api/v2/station/bikes')}>Trạng thái: bận</div>
